...
@Index("nom_provenance_pkey", ["id"], { unique: true })
@Index("idx_945b90f936305bb", ["nodeAt"], {})
@Index("idx_945b90f7805653", ["schoolYearAt"], {})
@Entity("nom_provenance", { schema: "public" })
export class NomProvenance {
  ...
  @OneToMany(
    ...
    (rIncomeSourceProvenanceCurrentSituation) =>
      rIncomeSourceProvenanceCurrentSituation.provenance
  )
